<template>
    <div :class="classname" class="p-2 m-4 flex justify-between text-xl border-b-2 border-red-600">
        <h1 :class="classname">{{ name }}</h1> 
        <h1 class="mx-12 text-sm text-gray-700">{{ proposed_start }} - {{ proposed_end }}</h1> 
    </div>
</template>
