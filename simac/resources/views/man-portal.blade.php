        ...
        <div class="flex">
            <div class="hidden lg:flex lg:flex-col lg:w-1/4 lg:m-8 lg:p-8 bg-white shadow-md rounded">
                ...
                <div class="mt-4">
                    <ul class="list-none text-lg">
                        <li class="pt-2 pb-2 cursor-pointer">Schedule a meeting</li>
                        <li class="pt-2 pb-2 cursor-pointer">Generate report</li>
                        <li class="pt-2 pb-2 cursor-pointer">Recent check-ins</li>
                        <li class="pt-2 pb-2 cursor-pointer">Upload documents</li>
                    </ul>
                </div>
            </div>
            <div class="flex-grow lg:flex lg:justify-center lg:flex-grow-0 lg:w-3/4">
                <div class="bg-white m-4 pt-4 shadow-md rounded lg:w-3/4 lg:m-8">
                    <h1 class="text-center text-lg md:text-xl lg:text-2xl">Schedule a meeting</h1>
                    <div class="px-4 py-2 text-md block lg:text-xl">
                        <form action="" method="post">
                            <div class="flex-col my-4 w-full">
                                <div class="m-4">
                                    <select class="block rounded w-full p-2 border border-grey-light bg-white">
                            ...
                            <div class="p-4 flex justify-center">
                                <button class="block mx-auto shadow bg-red-600 hover:bg-red-700 focus:shadow-outline focus:outline-none text-white py-2 px-6 rounded">Next</button>
                            </div>
                        </form>
                    </div>
                </div>
